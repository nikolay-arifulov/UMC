...
class EventGraphQLFunctionalTest {

    @Autowired
    private TestRestTemplate restTemplate;

    @Autowired
    private VenuePgRepository venueRepository;
    ...
    void setUp() {
        ...
        var venue = new VenuePgEntity();
        venue.setReferenceId("venue-123");
        venue.setName("Test Venue");
        venue.setId(new FullExternalIdPk("BRAND", "PROVIDER", "EXT123"));
